...
@section('content')
    ...
    <div class="container-fluid py-5 machinery-title" style="background-color: #FFEBC6;">
        ...
        <div class="container-fluid pt-5 food-sub">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <h5 style="text-align: justify;">We import & supply high quality food additives, stabilizers, emulsifiers, food flavours and food colorings for food industry.</h5>
                    </div>
                </div>
            </div>
        </div>
