...
@section('content')
    ...
    <div class="container-fluid py-5 machinery-title px-0" style="background-color: #E1E8F6;">
        <div class="container text-center">

            <div class="row justify-content-center">
                <div class="col-12">
                    <h1 data-aos="fade-up" data-aos-duration="500">Fish Processing and Canning Industry</h1>
                </div>
            </div>
        </div>
        ...
        <div class="container blue">
            <div class="row justify-content-center mb-3">
                <div class="col-md-8 col-lg-6">
                    <p style="text-align:justify;" data-aos="fade-up" data-aos-duration="500">Import and supply of brand-new and used machinery for fish processing and canning.</p>
